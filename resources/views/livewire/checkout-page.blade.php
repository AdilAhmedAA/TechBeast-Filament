                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                ...
                                id="phone" wire:model="phone" type="text">
                            </input>
                            @error('phone')
                                <div class="text-red-500 text-sm">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                ...
                                id="address" wire:model="street_address" type="text">
                            </input>
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                ...
                                id="city" wire:model="city" type="text">
                            </input>
                            @error('city')
                                <div class="text-red-500 text-sm">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input
                                    ...
                                    id="state" wire:model="state" type="text">
                                </input>
                                @error('state')
                                    <div class="text-red-500 text-sm">{{ $message }}</div>
                                @enderror
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="zip" wire:model="zip_code" type="text">
                                </input>
                                @error('zip_code')
                                    <div class="text-red-500 text-sm">{{ $message }}</div>
                                @enderror
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        <li>
                            ...
                            <label
                                class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 @error('payment_method') border-red-500 @enderror"
                                for="hosting-small">
                                <div class="block">
