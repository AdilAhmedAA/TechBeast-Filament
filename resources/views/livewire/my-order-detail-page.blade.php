<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    @php
        ...
        if ($order->payment_status == 'paid') {
            $paymentstatus = '<span class="bg-green-700 py-1 px-3 rounded  text-white shadow">Paid</span>';
        }
        if ($order->payment_status == 'failed') {
            $paymentstatus = '<span class="bg-red-700 py-1 px-3 rounded  text-white shadow">Failed</span>';
        }
    @endphp
    <!-- Grid -->
            ...
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center  gap-x-2">
                        <h3 class="text-xl font-medium text-gray-800 dark:text-gray-200">{{ $address->full_name }}</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="flex flex-col md:flex-row gap-4 mt-4">
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                    <span>{{Number::currency($order->taxes? : '0.00', 'PKR')}}</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Shipping</span>
                    <span>{{Number::currency($order->shipping_amount? : '0.00', 'PKR')}}</span>
                </div>
                <hr class="my-2">
                <div class="flex justify-between mb-2">
                    <span class="font-semibold">Grand Total</span>
                    <span class="font-semibold">{{Number::currency(0, 'PKR')}}</span>
                </div>
