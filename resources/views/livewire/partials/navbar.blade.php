        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between pt-2 pb-2">
                <a wire:navigate
                    ...
                    <img class="max-h-12 md:max-h-16 w-full object-contain dark:hidden" src="{{ url('storage', $logo) }}"
                        alt="">
                    <img class="max-h-12 md:max-h-16 w-full object-contain hidden dark:inline"
                        src="{{ url('storage', $logowhite) }}" alt="">
