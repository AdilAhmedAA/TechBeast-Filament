        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                @foreach ($brands as $brand)
                    <div class="bg-white rounded-lg shadow-md dark:bg-gray-800 p-2" wire:key="{{ $brand->id }}">
                        <a wire:navigate href="/products?selected_brands[0]={{$brand->id}}" class="">
                            <img src="{{ url('storage', $brand->image) }}" alt="{{ $brand->image }}"
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    ...
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                <div class="flex mr-3 text-sm text-gray-700 dark:text-gray-400">
                                    <a wire:navigate href="#"><svg xmlns="http://www.w3.org/2000/svg"
