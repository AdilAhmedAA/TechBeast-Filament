                ...
                Group::make()->schema([
                    ...
                    Section::make('Order Items')->schema([
                        Repeater::make('items')->relationship()->schema([
                            ...
                            TextInput::make('total_amount')->numeric()->required()->disabled()->dehydrated()->columnSpan(3),
                        ])->columns(12),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('grand_total')->numeric()->money('PKR')->sortable(),
                TextColumn::make('payment_method')->searchable()->sortable()->toggleable(isToggledHiddenByDefault: false),
                TextColumn::make('payment_status')->searchable()->sortable()->toggleable(isToggledHiddenByDefault: false),
                TextColumn::make('currency')->searchable()->sortable()->toggleable(isToggledHiddenByDefault: false),
                TextColumn::make('shipping_method')->searchable()->sortable()->toggleable(isToggledHiddenByDefault: false),
